...
\input{chapters/02-getting-started}
\input{chapters/03-parent-portal}
\input{chapters/04-student-portal}
\input{chapters/05-teacher-portal}
\input{chapters/06-admin-portal}
\input{chapters/07-faq}
